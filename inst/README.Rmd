...
Depending on which functions and methods you are using, other references may also be fair. [Here you can find out in detail how to cite `anticlust`](HOW_TO_CITE_ANTICLUST.md).

...
- The [package website](https://m-py.github.io/anticlust/) contains all documentation as a convenient website. At the current time, the website also lists three package vignettes, while additional vignettes are planned.

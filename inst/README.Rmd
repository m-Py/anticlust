...
This README contains some basic information the package `anticlust`. More 
...
3. Use the R help. The main function of the package is `anticlustering()`
...
`balanced_clustering()` and `matching()`. For more information on these 
functions, consult their respective help pages and see the examples 
below.

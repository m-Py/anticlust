...
- Create any number of sets that are similar with regard to the numeric
  features of the input elements (e.g., create school classes with pupils 
  of similar grades)
...
We want to investigate the descriptive statistics

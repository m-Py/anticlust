...
#' \code{objective = "distance"}, the Euclidean distance is computed
#' as the basic unit of the anticluster editing
...
#' same anticluster (setting \code{preclustering = TRUE}). For large N (> 100),

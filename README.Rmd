...
the sets are as similar as possible [@spath1986; @valev1998]. Cluster
analysis is the better known twin of anticlustering; cluster analysis is
used to create sets in such a way that elements within each set are
similar, but dissimilar from elements in other sets. 
...
The help page of the function (`?anticlustering`) is useful to learn
...
Framework](https://osf.io/cd5sr/) that includes materials to better
understand the anticlustering method. Currently, it contains the slides
of a talk that I gave a the TeaP conference (Annual meeting of
...
If you have any question on the anticlustering method and the
`anticlust` package, I encourage you to contact me via email
(martin.papenberg@hhu.de) or Twitter (`@MPapenberg`) or to open an issue

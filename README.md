...
-   Create any number of sets that are similar with regard to the numeric features of the input elements (e.g., create school classes with pupils of similar grades)
-   All sets are of equal size
-   Group memberships may be balanced out across sets (e.g., each school class has the same number of female and male students)
...
4.  If you have any question on the anticlustering method and the `anticlust` package, I encourage you to contact me via email (<martin.papenberg@hhu.de>) or [Twitter](https://twitter.com/MPapenberg) or to open an issue on this Github repository.

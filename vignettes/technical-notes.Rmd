...
of a cluster size $K$. That is, each precluster contains as many
elements as there are anticlusters. For $K = 2$, the preclustering
corresponds to the minimum weight perfect matching problem
[@gerards1995]. The left-hand plot in Figure 2 illustrates the
...
the right-hand plot of Figure 2. Note that the optimal solution
sometimes would sometimes require to join elements that are part of the
same precluster. Therefore, the preprocessing sometimes precludes an
optimal solution.

...
variable is artificially categorized. However, I would suggest to try 
out the Min-Max-Anticlustering approach first as it tends to better 
maximize differences between the `split` variable while ensuring that

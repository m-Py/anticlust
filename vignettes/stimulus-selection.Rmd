...
- Minimize differences between sets with regard to some variables
- Maximize differences between sets with regard to some variables
- Balance the occurrence of a categorical variable between sets
- Select a subset of the total stimulus pool -- or assign each stimulus 
  to a set

We use norming data for the open stimulus pool OASIS for this purpose 
